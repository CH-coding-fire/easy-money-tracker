...
export const DEFAULT_CATEGORIES: CategoryGroup = {
  expense: [
    cat('Food', '🍔', [
      ...
      leaf('Snack', '🍿'), leaf('Delivery', '🚚'), leaf('Unclassified'),
    ]),
    cat('Housing', '🏠', [
      leaf('Rent', '🔑'), leaf('Mortgage', '🏦'), leaf('Property Tax', '📋'),
      leaf('Insurance', '🛡️'), leaf('Maintenance', '🔧'),
      leaf('Management Fee', '📂'), leaf('Moving Expense', '📦'), leaf('Unclassified'),
    ]),
    cat('Utility', '💡', [
    ...
    cat('Transportation', '🚗', [
      ...
      leaf('Flight', '✈️'), leaf('Unclassified'),
    ]),
    cat('Medical', '🏥', [
      ...
      leaf('Checkup', '📋'), leaf('Unclassified'),
    ]),
    cat('Insurance', '🛡️', [
    ...
    cat('Social', '🎉', [
      ...
      leaf('Party & Event', '🎊'), leaf('Networking', '🤝'), leaf('Unclassified'),
    ]),
    cat('Love Life', '❤️', [
    ...
    cat('Education', '📚', [
      ...
      leaf('Certification', '🏅'), leaf('Unclassified'),
    ]),
    cat('Fitness/Health', '💪', [
      leaf('Membership', '🏋️'), leaf('Class', '🧘'), leaf('Coaching', '👟'),
      leaf('Equipment', '🏓'), leaf('Supplement', '💊'),
      leaf('Event', '🏃'), leaf('Unclassified'),
    ]),
    cat('Substance', '🚬', [
      leaf('Alcohol', '🍷'), leaf('Tobacco', '🚬'), leaf('Cannabis', '🌿'),
      leaf('Psychedelic'), leaf('Stimulant'), leaf('Unclassified'),
    ]),
    cat('Entertainment', '🎮', [
    ...
    cat('Shopping', '🛍️', [
      ...
      leaf('Merchandise', '👕'), leaf('Tool', '🔨'), leaf('Unclassified'),
    ]),
    cat('Beauty', '💄', [
